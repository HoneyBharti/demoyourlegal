...
const steps = [
    {
        ...
        details: [
            {
                title: 'Choose your jurisdiction and business activity.',
                items: [
                    {
                        title: 'Free Zone vs Mainland',
                        description: 'Free Zone is ideal for international trade and services, offering 0% corporate tax on qualifying income. Mainland is required for trading directly within the UAE local market.',
                    },
                ]
            }
        ],
    },
    {
        ...
        details: [
            {
                title: 'We get your trade name and initial approvals from the relevant authority (e.g., DED for Mainland, or the Free Zone authority).',
                items: []
            },
        ],
    },
    {
        number: 3,
        title: 'MOA & Legal Documents',
        details: [
            {
                title: 'We draft and handle the notarization of your Memorandum of Association (MOA) and other legal documents.',
                items: []
            }
        ],
    },
    {
        ...
        details: [
           {
                title: 'Your official Trade License is issued.',
                items: []
            },
            {
                title: 'We manage the application for your company Establishment Card and begin the visa process for you and your employees.',
                items: []
            }
        ],
    },
    {
        ...
        details: [
            {
                title: 'With your license and documents in hand, we provide expert assistance to navigate the corporate bank account opening process.',
                items: []
            }
        ],
    },
            ...
            <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4">
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">Launch Your Dubai Business</span>
                    </h1>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
                        We've simplified the complex process of starting a business in the UAE into a few straightforward steps.
                    </p>
                    <div className="flex justify-center gap-4">
                        <Button onClick={() => router.push('/dubai')} size="lg">View Pricing</Button>
